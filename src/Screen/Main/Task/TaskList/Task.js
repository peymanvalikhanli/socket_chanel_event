        ...
        <Content>
          ...
          {this.state.hideattachment && (
            <View
              ...
              <Image
                ...
                style={{width: deviceWidth / 2, height: 200}}
                resizeMode="stretch"
              />
            </View>
          )}
          <View style={{backgroundColor: 'lightblue'}}>
            <FlatList
              ...
              renderItem={({item}) => <Checklist item={item.name} />}
            />
          </View>
          ...
          <View
            ...
            <TouchableOpacity style={{marginTop: 15, paddingRight: 10}}>
              <Icon
                name="comment-o"
                type="FontAwesome"
                style={{fontSize: 30, color: 'rgb(150,150,150)'}}
              />
            </TouchableOpacity>
            <TextInput
              multiline={true}
          ...
          <Modal
            ...
            <View
              style={{height: 300, backgroundColor: '#ffff', borderRadius: 5}}>
              ...
              <TouchableOpacity
                ...
                <Text style={{fontSize: 20, color: '#29487d', marginTop: 20}}>
                  Done
                </Text>
              </TouchableOpacity>
            </View>
          ...
          <Modal
            ...
            <View
              ...
              <TouchableOpacity
                ...
                />
                <Text style={{fontSize: 22, color: 'black', paddingLeft: 20}}>
                  Take photo
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
